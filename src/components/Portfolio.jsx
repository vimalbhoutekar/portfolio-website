        ...
        <div className="text-center">
          <div className="mb-8">
            ...
            <div className="flex justify-center space-x-6 mb-8">
              <a href="https://linkedin.com/in/vimalbhoutekar" className="text-gray-300 hover:text-purple-400 transition-colors">
                <Linkedin className="w-6 h-6" />
              </a>
              <a href="https://github.com/vimalbhoutekar" className="text-gray-300 hover:text-purple-400 transition-colors">
                <Github className="w-6 h-6" />
              </a>
              <a href="https://leetcode.com/vimalbhoutekar" className="text-gray-300 hover:text-purple-400 transition-colors">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                liveLink: "https://vimalmovie.onrender.com/",
            ...
            {[
              {
                ...
                provider: "Udemy",
                icon: "🐍",
                certificateUrl: "https://www.udemy.com/certificate/UC-1e61ff85-7e7c-41b4-9808-082c5fe32172/", // Add your certificate URL
              },
              {
                title: "Front-End Development",
                provider: "Udemy",
                icon: "💻",
                certificateUrl: "https://www.udemy.com/certificate/UC-6e4b5ed3-7e07-4582-9a68-47cf2a6bf1e0/", // Add your certificate URL
              },
              {
                title: "SQL Certificate",
                provider: "LinkedIn Learning",
                icon: "🗄️",
                certificateUrl: "https://www.linkedin.com/learning/certificates/b9432ac7868954e95dad359d7e8bd9524c5110906209b532f4487ca2d77b8813?trk=share_certificate", // Add your certificate URL
              },
            ].map((cert, index) => (
              <div
                key={index}
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            ...
            <div className="text-center mt-12">
              ...
              <div className="flex justify-center space-x-6">
                <a
                  href="https://linkedin.com/in/vimalbhoutekar"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://leetcode.com/vimalbhoutekar"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-3 rounded-full hover:from-purple-600 hover:to-pink-600 transition-all duration-200 transform hover:scale-110"
                >
